...
## About
Chronicle은 대규모 트래픽 환경에서 발생하는 로그를 안정적으로 수집하여, 서비스 성능에 영향을 최소화하면서도 대량 로그를 효율적으로 검색할 수 있도록 설계된 백엔드 시스템입니다.  
SDK를 통해 애플리케이션에서 발생하는 로그를 손쉽게 중앙 시스템으로 수집하고, 대시보드를 통해 빠르게 조회하는 것을 목표로 합니다.
...
## Architecture
<img width="1132" height="758" alt="chronicle drawio" src="https://github.com/user-attachments/assets/f498c5a6-a3f2-4bc0-8aa9-6c369d23aedc" />
